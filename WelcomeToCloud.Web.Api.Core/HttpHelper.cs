...
namespace WelcomeToCloud.Web.Api.Core
{
    public class HttpHelper :IDisposable
    {
        ...
        {
            string url = "http://bamadevws126/welcome_to_cloud_fr/welcome-to-cloud/hello";
            //string url = "http://bamadevwscore01/WelcomeToCloud.Framework/welcome-to-cloud/hello";
