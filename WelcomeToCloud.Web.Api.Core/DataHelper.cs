...
namespace WelcomeToCloud.Web.Api.Core
{
    public class DataHelper
    {
        ...
        private string[] FillDataCollection()
        {
            ...
            list.Add("It is impossible for most people to lick their own elbow");
            list.Add("A crocodile cannot stick its tongue out");
            list.Add("A shrimp's heart is in its head");
            list.Add("It is physically impossible for pigs to look up into the sky");
            list.Add("The 'sixth sick sheik's sixth sheep's sick' is believed to be the toughest tongue twister in the English language");
            list.Add("If you sneeze too hard, you could fracture a rib");
            list.Add("Wearing headphones for just an hour could increase the bacteria in your ear by 700 times");
            list.Add("In the course of an average lifetime, while sleeping you might eat around 70 assorted insects and 10 spiders, or more");
            return list.ToArray();
        }
    }
}